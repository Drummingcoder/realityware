        ...
        <main className="" id="home">
          <section id="hero" className="min-h-[100lvh] bg-background bg-[url(/Tiles.png)] bg-blend-multiply flex flex-col items-center">
            <header className="w-full">
              <nav className="w-full flex flex-row  py-4 px-6 gap-x-3">
                <Image src="/hackclubflag.png" alt="Hack Club logo" width={140} height={50} className="object-contain w-24 h-auto grayscale" />
                <h3>|</h3>
                <Image src="/d17Logo.svg" alt="Depot17 logo" width={140} height={50} className="object-contain w-24 h-auto grayscale" />
          ...
          {/* rephrase to clarify ts hardware focused ^^ */}
            ...
            <form name="rsvpForm" method="post" className="flex justify-between w-fit mx-auto gap-x-2">
              <div className="flex items-center bg-white border border-black rounded-lg px-3 h-14">
                <Image
                  src="/email.svg"
                  alt="Email"
                  width={24}
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-black placeholder-gray-400 focus:outline-none w-80"
                />
              </div>
              <div>
                <div className="bg-secondary/90 flex  rounded-lg px-6 gap-x-2 items-center h-14">
                  <input type="submit" value="RSVP" className="text-black font-medium text-xl -mt-0.5 3xl:-mt-1"></input>
                  <Image src="arrow.svg" alt="" width={14} height={14} className="" />
                </div>
            ...
            <div className="grow w-full bg-linear-to-t from-gray-200 to-transparent"></div>
