	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="The home page for Realityware! Doesn't show up if logged in (to be implemented)"
				/>
			</Head>

			<div className="fixed -top-1 right-0 z-50 max-width max-w-xs px-4 mt-8 text-center">
				<a
					href="http://localhost:8080/login/slack/"
					className="inline-block px-6 py-3 bg-black text-white rounded-lg shadow hover:opacity-90 transition"
				>
					Sign in with Slack!
				</a>
			</div>
			<div className="min-h-screen items-center justify-center">
				<header
					className="bg-background w-full mx-auto min-h-[20vh] pt-[18vh] pb-[12vw]"
					id="home"
				>
					{showTitle && (
						<div className="fixed top-0 left-0 w-full z-2 bg-background/80 backdrop-blur shadow text-left py-2 items-center flex">
							<span className="text-[calc(2vw+2vh)] font-bold text-foreground ml-[2vw] text-left">
								Realityware
							</span>
							<div className="z-50 max-width max-w-xs px-[2vw]">
								<img
									src="/static/hackclublogo.png"
									alt="Hack Club logo"
									width={181}
									height={63}
									className="object-contain w-[calc(6vw+10vh)] h-auto"
								/>
							</div>
							<nav className="flex flex-row items-center flex-1 z-3 mr-[2vw]">
								<ul className="flex flex-row space-x-[3vw] ml-auto">
									<li>
										<a
											href="#home"
											className="text-lg text-foreground hover:text-primary font-bold transition underline"
										>
											Home
										</a>
									</li>
					...
					<div className="absolute top-0 left-[38vw] z-50 max-width max-w-xs px-[4vw]">
						<img
							...
							width={181}
							height={63}
							className="object-contain w-[calc(8vw+15vh)] h-auto"
						/>
					</div>
					<nav className="absolute top-0 right-[2vw] w-full flex flex-row items-center justify-end py-4 z-50">
						<ul className="flex flex-row space-x-[4vw]">
							<li>
								<a
									href="#home"
									className="text-[calc(0.7vw+1.4vh)] text-foreground hover:text-accent font-bold transition underline"
								>
									Home
								</a>
							</li>
					...
					<div className="flex items-center justify-center mb-[3vh] relative">
						<h1 className="text-[calc(6vw+6vh)] font-bold text-center text-foreground flex-1">
							Realityware
						</h1>
					</div>
					<div className="flex justify-center">
						<p className="inline-block text-[calc(1.6vw+2vh)] mb-[2vh] text-primary text-center whitespace-wrap mx-[2vw]">
							Ship a solution to a problem of society, get a grant to build it!
						</p>
					</div>
					<p className="mb-[8vh] text-secondary text-center text-[calc(0.7vw+1.4vh)]">
					...
					<section className="space-y-4 mb-[8vh] flex justify-center">
						<a
							className="inline-block px-[3vw] py-[2.4vh] rounded shadow-lg text-foreground text-center text-white bg-lightaccent text-[calc(0.9vw+1vh)] hover:opacity-80 hover:bg-accent"
							href="/gallery"
						>
							RSVP here!
						</a>
				...
				<main className="w-full p-8 bg-background mx-auto" id="about">
					<section className="space-y-4">
						...
						<p className="mt-[4vh] block px-[1vw] py-[2vh] text-[calc(1.6vw+3.3vh)] rounded text-center underline text-primary">
							Completing the YSWS
						</p>
					</section>
					<section className="items-center flex mt-[10vh] justify-center portrait:flex-col">
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-secondary rounded-lg shadow-lg rounded text-center text-lightblack text-[calc(0.9vw+1.2vh)] overflow-y-auto">
							Step 1: Come up with an idea!{" "}
							<span className="block mt-[3vh] text-[calc(0.6vw+0.9vh)] text-justify">
						...
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-foreground rounded-lg shadow-lg rounded text-center text-white text-[calc(0.9vw+1.2vh)] overflow-y-auto">
						...
						<div className="w-[8vw] h-[6vh] portrait:w-[3vw] portrait:h-[5vh] bg-lightblue flex-shrink-0"></div>
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-primary rounded-lg shadow-lg rounded text-white text-center text-[calc(0.9vw+1.2vh)] overflow-y-auto">
					...
					<section className="items-center flex justify-center portrait:flex-col">
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-blue-900 rounded-lg shadow-lg rounded text-center text-white text-[calc(0.9vw+1.2vh)] overflow-y-auto z-1">
						...
						<div className="w-[8vw] h-[6vh] portrait:w-[3vw] portrait:h-[5vh] bg-lightblue flex-shrink-0"></div>
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-purple rounded-lg shadow-lg rounded text-lightblack text-center text-[calc(0.9vw+1.2vh)] overflow-y-auto">
							Step 4: Ship it!{" "}
							<span className="block mt-[3vh] text-[calc(0.6vw+0.9vh)] text-justify">
					...
					<section className="gap-[10vw] flex justify-center items-center">
						<p className="inline-block w-[25vw] h-[40vh] portrait:w-[40vw] portrait:h-[25vh] px-[1vw] py-[2vh] border border-[2vw] border-gray bg-yellow-500 rounded-lg shadow-lg rounded text-lightblack text-center text-[calc(0.9vw+1.2vh)] overflow-y-auto z-1">
					...
					<section
						className="flex items-center justify-center max-width mt-[18vh]"
						id="faq"
					>
						<div className="relative bg-white pb-[2vh] w-[67vw] h-auto border border-black border-[0.25vw] shadow-lg rounded [clip-path:polygon(0%_0%,calc(100%-6vw)_0%,100%_6vw,100%_100%,0%_100%)]">
							...
							<p className="relative text-center text-[calc(2vw+2vh)] underline mt-[2vh]">
					...
					<section className="flex items-center justify-center mt-[4vh] mb-[5vh]">
						<a
							className="block rounded w-[22vw] h-[16vh] px-[1vw] py-[2vh] rounded text-center bg-accent text-white rounded-full justify-center flex items-center text-[calc(0.73vw+1vh)]"
				...
				<footer className="bg-neutral w-full p-[4vh] mx-auto items-center justify-center flex">
					<section className="space-y-4">
						<p className="block px-[1vw] py-[2vh] rounded text-foreground text-[calc(0.9vw+1vh)]">
